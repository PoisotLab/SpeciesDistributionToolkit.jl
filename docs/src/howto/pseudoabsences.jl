...
presencelayer = mask(layer, records)

# We can for example generate a buffer for pseudo-absences in a radius of 90km
...
background = pseudoabsencemask(WithinRadius, presencelayer; distance = 90.0)
...
buffer = pseudoabsencemask(WithoutRadius, presencelayer; distance = 15.0)
...
pseudoabsencemask(BetweenRadius, presencelayer; closer = 15.0, further = 90.0)
