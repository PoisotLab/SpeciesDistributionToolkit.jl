...
an EPSG string, a PROJ4 string, or the WKT itself.
"""
...
@testitem "We can get the SRS from a string" begin
    from_epsg = _parse_projection_from_string("EPSG:4326")
    from_proj =
        _parse_projection_from_string("+proj=longlat +datum=WGS84 +no_defs +type=crs")
    from_wkt = _parse_projection_from_string(
        """
GEOGCS["WGS 84",DATUM["WGS_1984",SPHEROID["WGS 84",6378137,298.257223563,AUTHORITY["EPSG","7030"]],AUTHORITY["EPSG","6326"]],PRIMEM["Greenwich",0,AUTHORITY["EPSG","8901"]],UNIT["degree",0.0174532925199433,AUTHORITY["EPSG","9122"]],AUTHORITY["EPSG","4326"]]
""",
    )
    from_esri_wkt = _parse_projection_from_string(
        """
