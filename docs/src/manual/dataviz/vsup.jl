# # Value-suppressing maps

# The package has functions to produce value-suppressing uncertainty palettes.
...
# from recipes. For this reason, the legends for VSUP plots are provided as
