...
layerdescriptions(::RasterData{PaleoClim, BioClim}) = layerdescriptions(RasterData(CHELSA2, BioClim))

resolutions(::RasterData{PaleoClim, BioClim}) =
    Dict([2.5 => "2_5m", 5.0 => "5m", 10.0 => "10m"])

extrakeys(::RasterData{PaleoClim, BioClim}) =
    Dict([:timeperiod => ("LH", "MH", "EH", "YDS", "BA", "HS1", "LIG")])
