...
... it is encouraged to follow along. All the code that is required to run the
analysis is presented on the pages, and can be copied and pasted. Pay attention
to the output of each step!
...
If you have a good use case that you wonder how to achieve with the package, feel
