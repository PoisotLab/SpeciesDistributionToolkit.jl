...
any other `GBIFTaxon`.
"""
struct GBIFRecord <: OccurrencesInterface.Occurrence
    key::Int64
...
function GBIFRecord(o::Dict{String, Any})
    ...
    # generic name is absent, this defaults to the scientificName.
    ...
    formatted_record = GBIFRecord(
        ...
        get(o, "occurrenceStatus", "PRESENT") == "PRESENT",
    )
...
"""
mutable struct GBIFRecords <: OccurrencesInterface.Occurrences
